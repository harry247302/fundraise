...
<!-- shadab -->
<div>
<div style="margin:80px" class="tf-contaier  position-relative">
    <h3 style="text-align:center">Tailored Strategies</h3>
    <p style="width:70%;margin:auto;margin-bottom:40px">At Impact Nest, we believe that no two businesses are alike — and neither should their growth plans be.
...
actionable plans that fuel measurable outcomes. We don't just advise — we become your thinking1</p>
      ...
      <div class="col-md-3 ">
          ...
          <div class="process-item bg-1 step-hover active" style="border: 1px solid #ccc; border-radius: 12px; padding: 20px;">
              ...
              <div class="process-content">
                  <h6>
                      <a href="#" class="name-process">We help to reach  right audience with the right message at the right time.</a>
                  </h6>
                  <div   class="desc">
                  <strong>Our services include:</strong>
                  </div>
                  <ul style="color: #555; font-size: 14px; line-height: 1.4;">
      ...
      <div class="col-md-3">
          <div class="process-item bg-1 step-hover active" style="border: 1px solid #ccc; border-radius: 12px; padding: 20px; ">
              ...
              <div class="process-content">
                  ...
                  <div class="desc">
                  <strong><strong>Our services include:</strong></strong>
                  </div>
                  <ul style="color: #555; font-size: 14px; line-height: 1.4;">
      <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"></path>
...
<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"></path>
      ...
      <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"></path>
</svg> Financial  aligned with funding milestones</li>
      <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"></path>
      ...
      <div class="col-md-3">
          <div class="process-item bg-1 step-hover" style="border: 1px solid #ccc; border-radius: 12px; padding: 20px;">
              ...
              <div class="process-content">
                  <h6>
                      <a href="#" class="name-process"> We create the critical docs need to build trust and close deals.
                      </a>
                  </h6>
                  <div class="desc">
      ...
      <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                          <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"></path>
                          </svg> Financial projections and documentation</li>
      <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                          <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"></path>
...
<!-- 
            ...
            <section style="margin-top:100px" class="section-contact-home h-2 page-our-services tf-spacing-28">
 ...
 <footer class="footer" id="footer">
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
                                            ...
                                            <p style="color:black">                                       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
  <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
</svg> Team Teams & Our Experts</p> </a></li>
                            ...
                            <div class="footer-right">
                                   ...
                                   <div class="contact-footer">
                                    <div class="address contact-top contact-footer-content">
                                        ...
                                        <a style="color:black" href="#">      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
