...
<!-- Mirrored from themesflat.co/html/finwice/our-services-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 12:52:44 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    ...
    <div class="wrapper">
                                    ...
                                    <ul class="menu-primary-menu">
                                        ...
                                        <li class="menu-item menu-item-has-children position-relative current-menu-item">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="sub-menu-item current-item"><a href="our-services-2.php" class="item-link-2">Our Services 2</a></li>
        ...
        <div class="main-content">
            ...
            <div class="tf-container">
                <div class="row">
                    <div class="col-12">
                        <div class="list-section-services-item tf-spacing-2">
                            <div class="section-services-item style-border">
                                <div class="image tf-animate-1">
                                    <a href="services-details-1.php" class="link"></a>
                                    <img src="image/section-services-item/section-services-item-1.jpg" data-src="image/section-services-item/section-services-item-1.jpg" alt="" class="lazyload">
                                </div>
                                <div class="services-content">
                                    <div class="heading">
                                        <h3 class="wow fadeInUp"><a href="services-details-1.php" class="name-services">Retirement Planning</a>
                                        </h3>
                            ...
                            <div class="section-services-item style-border">
                                <div class="image tf-animate-1">
                                    <a href="services-details-1.php" class="link"></a>
                                    <img src="image/section-services-item/section-services-item-2.jpg" data-src="image/section-services-item/section-services-item-2.jpg" alt="" class="lazyload">
                                </div>
                                <div class="services-content">
                                    <div class="heading">
                                        <h3 class="wpw fadeInUp"><a href="services-details-1.php" class="name-services">Investment Advisory</a>
                                        </h3>
                                        <div class="sub-name body-2 wow fadeInUp">
                                            Receive expert guidance on building a diversified investment portfolio
                                            <br>that aligns with your financial goals, risk tolerance, and long-term
                                            <br>growth objectives for maximum returns.
                                        </div>
                                    </div>
                                    <div class="benefit-lists">
                                        <div class="benefit-items">
                            ...
                            <div class="section-services-item style-border">
                                <div class="image tf-animate-1">
                                    <a href="services-details-1.php" class="link"></a>
                                    <img src="image/section-services-item/section-services-item-3.jpg" data-src="image/section-services-item/section-services-item-3.jpg" alt="" class="lazyload">
                                </div>
                                <div class="services-content">
                                    <div class="heading">
                                        <h3 class="wpw fadeInUp"><a href="services-details-1.php" class="name-services">Estate Planning</a>
                                        </h3>
                                        <div class="sub-name body-2 wow fadeInUp">
                                            Create a solid estate plan to protect your assets, ensuring a smooth
                                            <br>transition of wealth to future generations while minimizing taxes and
                                            <br>legal complications.
                                        </div>
                                    </div>
                                    <div class="benefit-lists">
                                        <div class="benefit-items">
                            ...
                            <div class="section-services-item style-border">
                                <div class="image tf-animate-1">
                                    <a href="services-details-1.php" class="link"></a>
                                    <img src="image/section-services-item/section-services-item-4.jpg" data-src="image/section-services-item/section-services-item-4.jpg" alt="" class="lazyload">
                                </div>
                                <div class="services-content">
                                    <div class="heading">
                                        <h3 class="wpw fadeInUp"><a href="services-details-1.php" class="name-services">Tax Optimization</a>
                                        </h3>
                                        <div class="sub-name body-2 wow fadeInUp">
                                            Maximize your savings with personalized strategies to reduce tax
                                            <br>liabilities and enhance financial efficiency, keeping you prepared for
                                            tax
                                            <br>season and unforeseen expenses.
                                        </div>
                                    </div>
                                    <div class="benefit-lists">
                                        <div class="benefit-items">
            ...
            <!-- Section-process -->
            <section class="section-process h-5 page-our-services-2 bg-surface tf-spacing-2 ">
                <div class="tf-container position-relative">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center">
                                <div class="text-anime-wave-1">
                                    <a href="#" class="tag label text-btn-uppercase">Our Process</a>
                                </div>
                                <h3 class="text-anime-wave-1 mb-12">Our Data Analytics Process</h3>
                                <div class="sub-title body-2 text-anime-wave-1">
                                    Our approach to data analytics is built around delivering actionable insights that drive success
                                </div>
                            </div>
                            <div class="process-list hover-active-step">
                                <div class="process-item style-2 hover-img step-hover">
                                    <div class="image">
                                        <img src="image/section/process-item-1.jpg" data-src="image/section/process-item-1.jpg" alt="" class="lazyload">
                                    </div>
                                    <span class="label text-btn-uppercase color-primary">Step 1</span>
                                    <div class="process-content text-center">
                                        <h5>
                                            <a href="#" class="name-process">Market Analysis</a>
                                        </h5>
                                        <div class="desc">
                                            We analyze trends and competitor strategies to uncover opportunities.
                                        </div>
                                    </div>
                                ...
                                <div class="process-item style-2 hover-img step-hover">
                                    <div class="image">
                                        <img src="image/section/process-item-2.jpg" data-src="image/section/process-item-2.jpg" alt="" class="lazyload">
                                    </div>
                                    <span class="label text-btn-uppercase color-primary">Step 2</span>
                                    <div class="process-content text-center">
                                        <h5>
                                            <a href="#" class="name-process">Strategy Development</a>
                                        </h5>
                                        <div class="desc">
                                            We create tailored marketing strategies to meet your business goals.
                                        </div>
                                    </div>
                                    <div class="icon-list item-1">
                                        <i class="icon-connect-line-2"></i>
                                    </div>
                                </div>
                                <div class="process-item style-2 hover-img step-hover">
                                    <div class="image">
                                        <img src="image/section/process-item-3.jpg" data-src="image/section/process-item-3.jpg" alt="" class="lazyload">
                                    </div>
                                    <span class="label text-btn-uppercase color-primary">Step 3</span>
                                    <div class="process-content text-center">
                                        <h5>
                                            <a href="#" class="name-process">Implementation</a>
                                        </h5>
                                        <div class="desc">
                                            Our team executes the plan & manages campaigns for optimal results.
                                        </div>
                                    </div>
                                    <div class="icon-list item-2">
                                        <i class="icon-connect-line-1"></i>
                                    </div>
                                </div>
                                <div class="process-item style-2 hover-img step-hover">
                                    <div class="image">
                                        <img src="image/section/process-item-4.jpg" data-src="image/section/process-item-4.jpg" alt="" class="lazyload">
                                    </div>
                                    <span class="label text-btn-uppercase">Step 4</span>
                                    <div class="process-content text-center">
                                        <h5>
                                            <a href="#" class="name-process">Performance Tracking</a>
                                        </h5>
                                        <div class="desc">
                                            We track KPIs to refine strategies and enhance campaign effectiveness.
                                        </div>
                                    </div>
                                    <div class="icon-list item-3">
                                        <i class="icon-connect-line-2"></i>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Section-why-choose -->
            <section class="section-why-choose h-4 tf-spacing-31">
                <div class="tf-container position-relative">
                    <div class="row rg-60 align-items-center">
                        <div class="col-lg-6">
                            <div class="section-content">
                                <div class="heading-section">
                                    ...
                                    <h3 class="text-anime-wave mb-12"> Why Choose Us for Your <br>Digital Transformation?</h3>
                                    <div class="sub-title body-2 text-anime-wave"> We offer unparalleled expertise and tailored solutions to navigate your digital journey. Our team combines deep industry knowledge with cutting-edge technology to drive transformative results. Partner with us to experience innovation, efficiency, and sustainable growth.</div>
                                </div>
                                <div class="benefit-lists">
                                    <div class="benefit-items text-anime-wave">
                                        <div class="icon">
                                            <i class="icon-checkbox"></i>
                                        </div>
                                        <div class="title">
                        ...
                        <div class="col-lg-6">
                            <div class="image tf-animate-4">
                                <img src="image/section/img-section-why-choose-h4.jpg" data-src="image/section/img-section-why-choose-h4.jpg" alt="" class="lazyload">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section-cta h-2 h-4">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="cta-inner style-2">
                                <div class="cta-content">
                                    <h4 class="title-content">
                                        ...
                                        <br>Build Your Success Together Today!
                                    </h4>
                        ...
                        <li class="menu-item menu-item-has-children-mobile current-menu-mobile-item">
                            ...
                            <div id="dropdown-menu-2" class="collapse" data-bs-parent="#menu-mobile">
                                <ul class="sub-menu-mobile">
                                    ...
                                    <li class="menu-item current-menu-mobile-item"><a href="our-services-2.php">Our Services 2</a></li>
                                    ...
                                    <li class="menu-item"><a href="services-details-3.php">Services Details 3</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="menu-item menu-item-has-children-mobile">
...
<!-- Mirrored from themesflat.co/html/finwice/our-services-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 12:52:46 GMT -->
</html>
