...
<!-- Mirrored from themesflat.co/html/Impact Nest/services-details-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 12:52:50 GMT -->
                                    ...
                                    <ul class="menu-primary-menu">
                                        ...
                                        <li class="menu-item menu-item-has-children position-relative current-menu-item">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="sub-menu-item current-item"><a href="services-details-2.php" class="item-link-2">Services Details 2</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="flat-animate-tab">
                            <div class="wg-tab style-2 mb-60">
                                <ul class="tab-product" role="tablist">
                                    <li class="nav-tab-item" role="presentation">
                                        <h6>
                                            <a href="#tab-1" data-bs-toggle="tab" role="tab" class="active">Retirement Planning</a>
                                        </h6>
                                    </li>
                                    <li class="nav-tab-item" role="presentation">
                                        <h6>
                                            <a href="#tab-2" data-bs-toggle="tab" role="tab">Investment Advisory</a>
                                        </h6>
                                    </li>
                                    <li class="nav-tab-item" role="presentation">
                                        <h6>
                                            <a href="#tab-3" data-bs-toggle="tab" role="tab">Estate Planning</a>
                                        </h6>
                                    </li>
                                    <li class="nav-tab-item" role="presentation">
                                        <h6>
                                            <a href="#tab-4" data-bs-toggle="tab" role="tab">Tax Optimization</a>
                                        </h6>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-has-children-mobile current-menu-mobile-item">
                            ...
                            <div id="dropdown-menu-2" class="collapse" data-bs-parent="#menu-mobile">
                                <ul class="sub-menu-mobile">
                                    ...
                                    <li class="menu-item current-menu-mobile-item"><a href="services-details-2.php">Services Details 2</a></li>
                        ...
                        <li class="menu-item menu-item-has-children-mobile">
                            ...
                            <div id="dropdown-menu-3" class="collapse" data-bs-parent="#menu-mobile">
                                <ul class="sub-menu-mobile">
                                    ...
                                    <li class="menu-item"><a href="case-studies-details.php">Case Studies Details</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="menu-item menu-item-has-children-mobile">
