...
<body>
    ...
    <div class="wrapper">
                                ...
                                <nav class="main-menu">
                                    <ul class="menu-primary-menu">
                                        ...
                                        <li class="menu-item menu-item-has-children position-relative current-menu-item">
                                            ...
                                            <ul class="sub-menu">
                                                <li class="sub-menu-item current-item"><a href="products.php" class="item-link-2">Products</a></li>
            ...
            <div class="tf-container">
                <div class="page-title-content">
                    <div class="breadkcum">
                        ...
                        <span class="caption-1 page-breadkcum">Shop</span>
                    </div>
                    <h2 class="title-page-title">
                        Our Product
                    </h2>
                    <div class="sub-title body-2">
                        Discover premium financial tools and resources designed to drive your business
                        <br>forward with confidence and clarity.
                    </div>
                </div>
            </div>
        </div><!-- /.page-title -->
        ...
        <div class="main-content">
            ...
            <div class="section-product-content tf-spacing-2">
                <div class="tf-container">
                    <div class="row rg-60">
                        <div class="col-xl-9">
                            <div class="tf-sort mb-30">
                                <div class="tf-sort-left tf-sort-content">
                                    <div class="text wow fadeInUp">
                                        Showing 1-8 of 11 results
                                    </div>
                                    <div class="shop-sale wow fadeInUp" data-wow-delay=".1s">
                                        <i class="icon-CheckCircle"></i>
                                        Shop sale items only
                                    </div>
                                </div>
                                <div class="tf-sort-right tf-sort-content">
                                    <span class="color-on-suface-variant-1 wow fadeInUp" data-wow-delay=".2s">Sort by:</span>
                                    <div class="nice-select style-border wow fadeInUp" data-wow-delay=".3s">
                                        <span class="current">Best Selling</span>
                                        <ul class="list">
                                            <li class="option option-all">Best Selling</li>
                                            <li class="option">Best Selling 1</li>
                                            <li class="option">Best Selling 2</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="row rg-40">
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        <div class="image wow fadeInUp">
                                            ...
                                            <a href="shopping-cart.php" class="tf-btn bg-on-suface-container style-3 text-center w-full">
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp">Essentials Storage
                                                Set (Black)</a>
                                            <div class="price title wow fadeInUp">
                                                $68.00
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img discount wow fadeInUp" data-wow-delay=".1s">
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp" data-wow-delay=".1s">Wave Pen Tray (Walnut)</a>
                                            <div class="price title wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp" data-wow-delay=".2s">Essentials Premium Set (Walnut)</a>
                                            <div class="price title wow fadeInUp" data-wow-delay=".2s">
                                                $68.00<span class="compare-at-price">$98.00</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp">Sticky Note Tray (White Oak)</a>
                                            <div class="price title wow fadeInUp">
                                                $68.00<span class="compare-at-price">$98.00</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        <div class="image wow fadeInUp" data-wow-delay=".1s">
                                            <a href="products-details.php">
                                                <img src="image/project-item/product-item-5.jpg" data-src="image/project-item/product-item-5.jpg" alt="" class="lazyload">
                                            </a>
                                            <a href="shopping-cart.php" class="tf-btn bg-on-suface-container style-3 text-center w-full">
                                                <span>Add To cart</span>
                                            </a>
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp" data-wow-delay=".1s">Catchall Tray (Large - White Oak)</a>
                                            <div class="price title wow fadeInUp" data-wow-delay=".1s">
                                                $68.00
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        <div class="image wow fadeInUp" data-wow-delay=".2s">
                                            <a href="products-details.php">
                                                <img src="image/project-item/product-item-6.jpg" data-src="image/project-item/product-item-6.jpg" alt="" class="lazyload">
                                            </a>
                                            <a href="shopping-cart.php" class="tf-btn bg-on-suface-container style-3 text-center w-full">
                                                <span>Add To cart</span>
                                            </a>
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp" data-wow-delay=".2s">Upright Two (Oak / Natural)</a>
                                            <div class="price title wow fadeInUp" data-wow-delay=".2s">
                                                $68.00<span class="compare-at-price">$98.00</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        <div class="image wow fadeInUp">
                                            <a href="products-details.php">
                                                <img src="image/project-item/product-item-7.jpg" data-src="image/project-item/product-item-7.jpg" alt="" class="lazyload">
                                            </a>
                                            <a href="shopping-cart.php" class="tf-btn bg-on-suface-container style-3 text-center w-full">
                                                <span>Add To cart</span>
                                            </a>
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp">Wireless Charging Pad (Maple)</a>
                                            <div class="price title wow fadeInUp">
                                                $68.00<span class="compare-at-price">$98.00</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        <div class="image wow fadeInUp" data-wow-delay=".1s">
                                            <a href="products-details.php">
                                                <img src="image/project-item/product-item-8.jpg" data-src="image/project-item/product-item-8.jpg" alt="" class="lazyload">
                                            </a>
                                            <a href="shopping-cart.php" class="tf-btn bg-on-suface-container style-3 text-center w-full">
                                                <span>Add To cart</span>
                                            </a>
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp" data-wow-delay=".1s">Upright One (Black / Natural)</a>
                                            <div class="price title wow fadeInUp" data-wow-delay=".1s">
                                                $68.00
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-item hover-img">
                                        <div class="image wow fadeInUp" data-wow-delay=".2s">
                                            <a href="products-details.php">
                                                <img src="image/project-item/product-item-9.jpg" data-src="image/project-item/product-item-9.jpg" alt="" class="lazyload">
                                            </a>
                                            <a href="shopping-cart.php" class="tf-btn bg-on-suface-container style-3 text-center w-full">
                                                <span>Add To cart</span>
                                            </a>
                                        ...
                                        <div class="product-item-content">
                                            <a href="products-details.php" class="name-product title wow fadeInUp" data-wow-delay=".2s">Wave Pen Tray (Black)</a>
                                            <div class="price title wow fadeInUp" data-wow-delay=".2s">
                                                $68.00
                                            </div>
                                        </div>
                            ...
                            <div class="wg-pagination style-2 wow fadeInUp" data-wow-delay="0s">
                                <ul class="flex">
                                    <li class=" wow fadeInUp">1</li>
                                    <li class="active wow fadeInUp" data-wow-delay=".1s">2</li>
                                    <li class=" wow fadeInUp" data-wow-delay=".2s">3</li>
                                    <li class=" wow fadeInUp" data-wow-delay=".3s"><i class="icon-arrow-right1"></i></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="tf-sidebar ml-30">
                                <div class="sidebar-item sidebar-search">
                                    <fieldset>
                                        <input type="text" placeholder="Search products...">
                                        <a href="#" class="tf-btn-search"><i class="icon-MagnifyingGlass"></i></a>
                                    </fieldset>
                                </div>
                                <div class="sidebar-item sidebar-content sidebar-categories">
                                    <h6 class="title-content">
                                        Product Categories
                                    </h6>
                                    <ul class="list">
                                        <li class="item">
                                            <a href="#">Financial Planning Tools</a>
                                            <p>(112)</p>
                                        </li>
                                        <li class="item">
                                            <a href="#">Investment Resources</a>
                                            <p>(32)</p>
                                        </li>
                                        <li class="item">
                                            <a href="#">Budgeting Software</a>
                                            <p>(42)</p>
                                        </li>
                                        <li class="item">
                                        ...
                                        <li class="item">
                                            <a href="#">Risk Management Tools</a>
                                            <p>(13)</p>
                                        </li>
                                        <li class="item">
                                ...
                                <div class="sidebar-item sidebar-content sidebar-price">
                                    <h6 class="title-content">
                                        Filter By Price
                                    </h6>
                                    <div class="range-slider">
                                        ...
                                        <div class="bottom">
                                            ...
                                            <a href="#" class="tf-btn bg-on-suface-container">
                                                <span>Filter</span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="sidebar-item sidebar-content sidebar-tags">
                                    <h6 class="title-content">
                                        Popular Tag
                                    </h6>
                                    <div class="tabs-list">
                                        <a href="#" class="tabs-item caption-1">Tools</a>
                                        <a href="#" class="tabs-item caption-1">Book</a>
                                        <a href="#" class="tabs-item caption-1">Software</a>
                                        <a href="#" class="tabs-item caption-1">Data</a>
                                        <a href="#" class="tabs-item caption-1">Solutions</a>
                                        <a href="#" class="tabs-item caption-1">Planning</a>
                                        <a href="#" class="tabs-item caption-1">Financial</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-right">
                                <div class="footer-subscribe">
                                    ...
                                    <div class="text caption-2">
                                        Sign up for updates on our latest news and events. No spam, just valuable insights!
                                    </div>
                                </div>
                    ...
                    <ul id="menu-mobile" class="menu">
                        ...
                        <li class="menu-item menu-item-has-children-mobile current-menu-mobile-item">
                            ...
                            <div id="sub-product-5" class="collapse" data-bs-parent="#menu-mobile">
                                <ul class="sub-menu-mobile">
                                    <li class="menu-item current-menu-mobile-item"><a href="products.php">Products</a></li>
