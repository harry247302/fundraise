...
<!-- Mirrored from themesflat.co/html/Impact Nest/gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 12:53:02 GMT -->
...
<body class="loadmore">
    ...
    <div class="wrapper">
                                    ...
                                    <ul class="menu-primary-menu">
                                        ...
                                        <li class="menu-item menu-item-has-children position-relative current-menu-item">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="sub-menu-item current-item"><a href="gallery.php" class="item-link-2">Gallery</a></li>
        ...
        <!-- Page-title -->
        <div class="page-title style-1 bg-img-10">
            <div class="tf-container">
                <div class="page-title-content">
                    <div class="breadkcum">
                        ...
                        <span class="caption-1 page-breadkcum">Gallery</span>
                    </div>
                    ...
                    <div class="sub-title body-2">
                        ...
                        <br>moments that highlight our commitment to excellence.
                    </div>
                </div>
            </div>
        </div><!-- /.page-title -->
        ...
        <div class="main-content tf-spacing-2">
            <div class="loadmore-item-1 gallery-list">
                <div class="tf-container position-relative">
                    <div class="row rg-40">
                        <div class="col-lg-4 col-md-6 fl-item-1">
                            <div class="gallery-item item-1 hover-img">
                                <div class="image">
                                    <img src="image/gallery-item/gallery-1.jpg" data-src="image/gallery-item/gallery-1.jpg" alt="" class="lazyload">
                                    <a href="#" class="link"></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 fl-item-1">
                            <div class="gallery-item item-2 hover-img">
                                <div class="image">
                                    <img src="image/gallery-item/gallery-2.jpg" data-src="image/gallery-item/gallery-2.jpg" alt="" class="lazyload">
                                    <a href="#" class="link"></a>
                                </div>
                                <div class="gallery-content">
                                    <a href="#" class="icon"><i class="icon-Eye"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 fl-item-1">
                            <div class="gallery-item item-3 hover-img">
                                <div class="image">
                                    <img src="image/gallery-item/gallery-3.jpg" data-src="image/gallery-item/gallery-3.jpg" alt="" class="lazyload">
                                    <a href="#" class="link"></a>
                                </div>
                                <div class="gallery-content">
                                    <a href="#" class="icon"><i class="icon-Eye"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 fl-item-1">
                            <div class="gallery-item item-4 hover-img">
                                <div class="image">
                                    <img src="image/gallery-item/gallery-4.jpg" data-src="image/gallery-item/gallery-4.jpg" alt="" class="lazyload">
                                    <a href="#" class="link"></a>
                                </div>
                                <div class="gallery-content">
                                    <a href="#" class="icon"><i class="icon-Eye"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 fl-item-1">
                            <div class="gallery-item item-5 hover-img">
                                <div class="image">
                                    <img src="image/gallery-item/gallery-5.jpg" data-src="image/gallery-item/gallery-5.jpg" alt="" class="lazyload">
                                    <a href="#" class="link"></a>
                                </div>
                                <div class="gallery-content">
                                    <a href="#" class="icon"><i class="icon-Eye"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 fl-item-1">
                            <div class="gallery-item item-6 hover-img">
                                <div class="image">
                                    <img src="image/gallery-item/gallery-6.jpg" data-src="image/gallery-item/gallery-6.jpg" alt="" class="lazyload">
                                    <a href="#" class="link"></a>
                                </div>
                                <div class="gallery-content">
                                    <a href="#" class="icon"><i class="icon-Eye"></i></a>
                        ...
                        <div class="col-12">
                            <div class="btn-load-more text-center view-more-button-1">
                                <button class="tf-btn style-1 bg-on-suface-container btn-loadmore-1"><span>Load More</span></button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul id="menu-mobile" class="menu">
                        ...
                        <li class="menu-item menu-item-has-children-mobile current-menu-mobile-item">
                            ...
                            <div id="dropdown-menu-4" class="collapse" data-bs-parent="#menu-mobile">
                                <ul class="sub-menu-mobile">
                                    ...
                                    <li class="menu-item current-menu-mobile-item"><a href="gallery.php">Gallery</a></li>
                        ...
                        <li class="menu-item menu-item-has-children-mobile current-menu-item">
                            ...
                            <div id="dropdown-menu-6" class="collapse" data-bs-parent="#menu-mobile">
                                <ul class="sub-menu-mobile">
                                    <li class="menu-item current-item"><a href="blog-right-sidebar.php">Blog Right Sidebar</a></li>
...
<!-- Mirrored from themesflat.co/html/Impact Nest/gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 12:53:07 GMT -->
