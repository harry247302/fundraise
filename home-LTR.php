...
<!-- Mirrored from themesflat.co/html/finwice/home-LTR.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 12:52:44 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body dir="rtl" class="counter-scroll popup-loader style-RTL">
    ...
    <div class="wrapper">
        ...
        <div class="page-title-home img-1">
        ...
        <div class="main-content">
            ...
            <section class="section-process h-1 tf-spacing-2 hover-active-step">
                <div class="tf-container">
                    <div class="row rg-30">
                        <div class="col-12">
                            <div class="heading-section style-2 mb-10">
                                <div class="left">
                                    <div class="text-anime-wave">
            ...
            <!-- Section-project -->
            <section class="section-project h-1">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section style-color-white text-center">
                                ...
                                <h3 class="title-section text-anime-wave-1">
                                    Success Stories
                                </h3>
                ...
                <div class="section-project-inner">
                    <div class="list-case">
                        <div class="sw-case-studies sw-case-studies-h1 swiper sw-layout" data-preview="4" data-tablet="2" data-mobile="1" data-mobile-sm="2" data-space-lg="0" data-space-md="0" data-space="0">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                            ...
                            <div class="cta-inner">
                                ...
                                <div class="cta-content">
                                    <div class="heading-section style-color-white mb-0">
                                        ...
                                        <h3 class="title-section wow fadeInUp">
                        ...
                        <li class="menu-item menu-item-has-children-mobile current-menu-mobile-item">
                            ...
                            <div id="dropdown-menu-1" class="collapse" data-bs-parent="#menu-mobile">
                                <ul class="sub-menu-mobile">
                                    ...
                                    <li class="menu-item current-menu-mobile-item"><a href="home-LTR.php">Home LTR</a></li>
                                </ul>
                            </div>
                        </li>
