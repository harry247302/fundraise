...
<!-- Mirrored from themesflat.co/html/finwice/index-one-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jun 2025 12:51:49 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
...
<body class="counter-scroll popup-loader">
    ...
    <div class="wrapper">
                        ...
                        <div class="top-bar-inner">
                            ...
                            <div class="tf-tb-right">
                                <div class="top-bar-content tf-phone-topbar">
                                    ...
                                    <p class="text-btn">1-555-678-8888</p>
                                </div>
        ...
        <!-- Header -->
        <header class="header style-1 style-absolute header-fixed" data-scroll-threshold="56" id="header">
            <div class="tf-container w-1870">
                <div class="row">
                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="page-title-content">
                                            ...
                                            <div class="sub-title body-2 tf-fade-top fade-item-2">
                                                Unlock your financial potential with personalized planning and expert advice
        ...
        <div class="main-content">
            ...
            <!-- Section-about -->
            <section class="section-about h-1 tf-spacing-2 section-one-page" id="about">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="heading-section about-content-left">
                                ...
                                <h3 class="text-color-change mb-40">
                                    At FinWice, we offer expert financial <br>planning to help you reach your goals. <br>Our team provides tailored strategies <br>and solutions for your financial success <br>and security.
                                </h3>
                                ...
                                <div class="counter-item">
                                    <div class="counter">
                                        <div class="number-counter mb--3">
                                            <h2 class="number odometer color-primary mb-2" data-to="20" data-inviewport="yes"> 0 </h2>
            ...
            <!-- Section-benefit -->
            <section class="section-benefit h-1 tf-spacing-3 section-one-page" id="benefit">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="box-icon">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="sub-title wow fadeInUp">
                                            Customized financial plans designed to meet your unique goals and financial situation.
                                        </div>
                                    </div>
                                </div>
                                <div class="box-icon">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="sub-title wow fadeInUp" data-wow-delay=".1s">
                                            Expert strategies to enhance investment returns and drive consistent growth for you.
                                        </div>
                                    </div>
                                </div>
                                <div class="box-icon">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="sub-title wow fadeInUp" data-wow-delay=".2s">
                                            Comprehensive solutions to safeguard assets and ensure long-term financial stability and safety.
                                        </div>
                                    </div>
                                </div>
                                <div class="box-icon">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="sub-title wow fadeInUp" data-wow-delay=".3s">
                                            Effective strategies to minimize tax liabilities and enhance financial returns and savings.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Section-services -->
            <section class="section-services h-1 tf-spacing-31 bg-surface section-one-page" id="services">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="flat-animate-tab">
                                    <div class="wg-tab">
                                        <ul class="tab-product min-w-757" role="tablist">
                                            <li class="nav-tab-item" role="presentation">
                                                <h5>
                                                    <a href="#retirement-planning" data-bs-toggle="tab" role="tab" class="active">Retirement Planning</a>
                                                </h5>
                                            </li>
                                            <li class="nav-tab-item" role="presentation">
                                                <h5>
                                                    <a href="#investment-advisory" data-bs-toggle="tab" role="tab">Investment Advisory</a>
                                                </h5>
                                            </li>
                                            <li class="nav-tab-item" role="presentation">
                                                <h5>
                                                    <a href="#estate-planning" data-bs-toggle="tab" role="tab">Estate Planning</a>
                                                </h5>
                                            </li>
                                            <li class="nav-tab-item" role="presentation">
                                                <h5>
                                                    <a href="#tax-optimization" data-bs-toggle="tab" role="tab">Tax Optimization</a>
                                                </h5>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="tab-content">
                                        <div class="tab-pane active show" id="retirement-planning" role="tabpanel">
                                            <div class="section-services-item">
                                                <div class="image tf-animate-1">
                                                    ...
                                                    <img src="image/section/section-services-1.jpg" data-src="image/section/section-services-1.jpg" alt="" class="lazyload">
                                                </div>
                                                <div class="services-content">
                                                    <div class="heading">
                                                        <h3><a href="services-details-1.php" class="name-services wow fadeInUp">Retirement Planning</a></h3>
                                        ...
                                        <div class="tab-pane" id="investment-advisory" role="tabpanel">
                                            <div class="section-services-item">
                                                <div class="image">
                                                    <a href="services-details-1.php" class="link"></a>
                                                    <img src="image/section/section-services-2.jpg" data-src="image/section/section-services-2.jpg" alt="" class="lazyload">
                                                </div>
                                                <div class="services-content">
                                                    <div class="heading">
                                                        <h3><a href="services-details-1.php" class="name-services wow fadeInUp">Investment Advisory</a></h3>
                                        ...
                                        <div class="tab-pane" id="estate-planning" role="tabpanel">
                                            <div class="section-services-item">
                                                <div class="image">
                                                    <a href="services-details-1.php" class="link"></a>
                                                    <img src="image/section/section-services-3.jpg" data-src="image/section/section-services-3.jpg" alt="" class="lazyload">
                                                </div>
                                                <div class="services-content">
                                                    <div class="heading">
                                                        <h3><a href="services-details-1.php" class="name-services">Estate Planning</a>
                                                        </h3>
                                                        <div class="sub-name body-2">
                                                            Develop a comprehensive strategy to secure your retirement with tailored savings and investment plans.
                                                        </div>
                                        ...
                                        <div class="tab-pane" id="tax-optimization" role="tabpanel">
                                            <div class="section-services-item">
                                                <div class="image">
                                                    <a href="services-details-1.php" class="link"></a>
                                                    <img src="image/section/section-services-4.jpg" data-src="image/section/section-services-4.jpg" alt="" class="lazyload">
                                                </div>
                                                <div class="services-content">
                                                    <div class="heading">
                                                        <h3><a href="services-details-1.php" class="name-services">Tax Optimization</a>
                                                        </h3>
                                                        <div class="sub-name body-2">
                                                            Develop a comprehensive strategy to secure your retirement with tailored savings and investment plans.
                                                        </div>
            ...
            <!-- Section-process -->
            <section class="section-process h-1 tf-spacing-2 hover-active-step section-one-page" id="process">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
            ...
            <!-- Section-project -->
            <section class="section-project h-1 bg-on-suface-container section-one-page" id="project">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section style-color-white text-center">
                                <div class="text-anime-wave-1">
                                    <a href="#" class="tag label text-btn-uppercase color-white">Our Featured Projects</a>
                                </div>
                ...
                <div class="section-project-inner">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="project-item">
                                        <a href="case-studies-details.php" class="link"></a>
                                        <div class="project-content">
                                            <h5>
                                                <a href="case-studies-details.php" class="name">Revamping Operations for Higher Efficiency</a>
                                            </h5>
                                            <div class="text text-btn-uppercase label">
                                ...
                                <div class="swiper-slide">
                                    <div class="project-item active">
                                        ...
                                        <div class="project-content">
                                            <h5>
                                                <a href="case-studies-details.php" class="name">Strategic Growth Plan for Market Expansion</a>
                                            </h5>
                                            <div class="text text-btn-uppercase label">
                    ...
                    <div class="list-image-project">
                        <div class="image-project">
                            <img src="image/case-studies-item/project-item-1.jpg" data-src="image/case-studies-item/project-item-1.jpg" alt="" class="lazyload">
                        </div>
                        <div class="image-project active">
                            <img src="image/case-studies-item/project-item-2.jpg" data-src="image/case-studies-item/project-item-2.jpg" alt="" class="lazyload">
                        </div>
                        <div class="image-project">
                            <img src="image/case-studies-item/project-item-3.jpg" data-src="image/case-studies-item/project-item-3.jpg" alt="" class="lazyload">
                        </div>
                        <div class="image-project">
                            <img src="image/case-studies-item/project-item-4.jpg" data-src="image/case-studies-item/project-item-4.jpg" alt="" class="lazyload">
                        </div>
                    </div>
                </div>
            ...
            <section class="section-testimonials h-1 tf-spacing-2 section-one-page" id="testimonials">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section style-2">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <div class="item-content">
                                                <div class="text">
                                                    FinWice provided innovative solutions and a clear strategy that increased our market share by 20%. Their expertise and professionalism led to exceptional results.
                                                </div>
                                                <div class="info-user">
                                                    <div class="image">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <div class="item-content">
                                                <div class="text">
                                                    Partnering with FinWice boosted our profitability by 30%, transforming operations with clear, measurable improvements in efficiency and revenue.
                                                </div>
                                                <div class="info-user">
                                                    <div class="image">
            ...
            <!-- section-faqs -->
            <section class="section-faqs h-1 tf-spacing-2 section-one-page" id="faqs">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="left">
                                    <div class="heading-section">
                                        ...
                                        <div class="sub-title body-2 text-anime-wave mb-40">
                                            Find answers to some of the most common questions about financial planning, from budgeting and investment strategies to retirement planning and managing debt.
                                        </div>
                                        <div class="text-anime-wave">
                                            <a href="#" class="tf-btn style-1 bg-on-suface-container">
                                                <span>
                                ...
                                <div class="right">
                                    <div class="wg-according" id="According">
                                        <div class="according-item">
                                            <h5>
                                                <a href="#according-1" data-bs-toggle="collapse" class="title-according collapsed">What is financial planning? <span></span></a>
                                            </h5>
                                        ...
                                        <div class="according-item">
                                            <h5>
                                                <a href="#according-2" data-bs-toggle="collapse" class="title-according">Why is financial planning important?<span></span></a>
                                            </h5>
                                        ...
                                        <div class="according-item">
                                            <h5>
                                                <a href="#according-3" data-bs-toggle="collapse" class="title-according collapsed">How often should I review my financial plan?<span></span></a>
                                            </h5>
                                        ...
                                        <div class="according-item">
                                            <h5>
                                                <a href="#according-4" data-bs-toggle="collapse" class="title-according collapsed">What are the key components of a financial plan?<span></span></a>
                                            </h5>
                                        ...
                                        <div class="according-item">
                                            <h5>
                                                <a href="#according-5" data-bs-toggle="collapse" class="title-according collapsed">Do I need a financial advisor to create a financial plan? <span></span></a>
                                            </h5>
            ...
            <!-- Section-new -->
            <section class="section-new h-1 tf-spacing-12 section-one-page" id="new">
                <div class="tf-container">
                    <div class="col-12">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tf-post-grid style-small hover-img">
                                            <div class="image">
                                                <img src="image/blog/tf-post-grid-13.jpg" data-src="image/blog/tf-post-grid-13.jpg" alt="" class="lazyload">
                                            ...
                                            <div class="tf-grid-post-content">
                                                <div class="position label text-btn-uppercase">
                                                    Strategy Consulting
                                                </div>
                                                <h5 class="title-post">
                                                    <a href="blog-details-1.php"> 5 Key Strategies for Sustainable Business Growth</a>
                                                </h5>
                                                <div class="sub-title">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-post-grid style-small hover-img">
                                            <div class="image">
                                                <img src="image/blog/tf-post-grid-8.jpg" data-src="image/blog/tf-post-grid-8.jpg" alt="" class="lazyload">
                                                <a href="blog-details-1.php" class="link"></a>
                                                <a href="#" class="date">
                                                    <span class="day">
                                                        18
                                            ...
                                            <div class="tf-grid-post-content">
                                                ...
                                                <h5 class="title-post">
                                                    <a href="blog-details-1.php">Navigating Digital Transformation in 2024</a>
                                                </h5>
                                                <div class="sub-title">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-post-grid style-small hover-img">
                                            <div class="image">
                                                <img src="image/blog/tf-post-grid-14.jpg" data-src="image/blog/tf-post-grid-14.jpg" alt="" class="lazyload">
                                                <a href="blog-details-1.php" class="link"></a>
                                                <a href="#" class="date">
                                                    <span class="day">
                                                        18
                                            ...
                                            <div class="tf-grid-post-content">
                                                ...
                                                <h5 class="title-post">
                                                    <a href="blog-details-1.php">Mastering Financial Planning for Success</a>
                                                </h5>
                                                <div class="sub-title">
            ...
            <!-- Section-awards -->
            <section class="section-awards h-1 tf-spacing-3 section-one-page" id="awards">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center">
                                ...
                                <h3 class="title-section mb-0 text-anime-wave-1">
                                    Recognized Excellence and <br>Certified Expertise
                                </h3>
                            </div>
            ...
            <!-- Section-cta -->
            <section class="section-cta h-1 tf-spacing-3 section-one-page" id="cta">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="cta-inner">
