                ...
                <div class="footer-top">
                    ...
                    <div class="footer-center">
                        <div class="footer-content our-services footer-col-block">
                            <div class="title-mobile label text-btn-uppercase text-body">
                                Categories
                            ...
                            <div class="tf-collapse-content" style="display: unset;">
                                <ul>
                                    <li class="support-item-footer caption-1"><a href="our-services-1.php"
                                            class="text-body">Fund Raising</a></li>
                        ...
                        <div class="footer-content our-services footer-col-block">
                            ...
                            <div class="tf-collapse-content" style="display: unset;">
                                <ul>
                                    ...
                                    <li class="support-item-footer caption-1"><a href="our-teams-industry.php"
                                            class="text-body"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            Team</a></li>
                                    <li class="support-item-footer caption-1"><a href="our-expert.php"
                                            class="text-body"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    ...
                                    <li class="support-item-footer caption-1"><a href="faq.php" class="text-body">
                                            ...
                                            FAQ</a></li>
                                    <li class="support-item-footer caption-1"><a href="contact-us.php"
                                            class="text-body"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <div class="footer-right">
                        <div class="footer-subscribe">
                            <div class="label text-btn-uppercase text-body">
